...
export default function TestimonialsDemo() {
  return (
    <PublicLayout>
      <Head title="Testimonials Demo" />
      <div className="py-20">
        <section className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h1 className="text-4xl font-bold mb-4">Circular Testimonials Demo</h1>
            <p className="text-muted-foreground">Showcasing the new testimonials component.</p>
          </div>

          {/* Light testimonials section */}
          <div className="bg-[#f7f7fa] p-20 rounded-lg min-h-[300px] flex flex-wrap gap-6 items-center justify-center relative mb-20">
            <div
